...
<template>
  <div class="min-h-screen flex flex-col bg-[var(--color-bg)] dark:bg-[var(--color-bg-dark)] bg-pattern-grid relative overflow-hidden">
    ...
    >
      <div
        class="absolute size-[180px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(16,185,129,0.46)_0%,rgba(52,211,153,0.18)_50%,transparent_100%)] dark:bg-[radial-gradient(circle,rgba(52,211,153,0.48)_0%,rgba(16,185,129,0.20)_60%,transparent_100%)] blur-[30px] transition-opacity duration-300"
        :style="{
          left: `${x}px`,
          top: `${y}px`,
          opacity: (x === 0 && y === 0) ? 0 : 1
