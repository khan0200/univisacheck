...
<template>
  ...
  >
    <div
      ref="heroBg"
      class="absolute inset-0 -z-10 bg-gradient-to-br from-primary-50 via-white to-secondary-50/40 dark:from-primary-950/40 dark:via-[var(--color-bg-dark)] dark:to-primary-950/20"
    />
    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-4 pt-16 pb-14 sm:pt-20 sm:pb-20">
        ...
        <div class="relative">
          ...
          >
            ...
            <UIcon
              ...
              class="size-4 text-[var(--color-text-secondary)] ml-1"
            />
          </a>
        </div>
      </div>
      ...
      <div class="grid sm:grid-cols-3 gap-4 mt-16">
        ...
        >
          ...
          <UIcon
            name="i-lucide-arrow-right"
            class="size-4 text-[var(--color-text-secondary)] opacity-0 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all mt-2"
          />
        </a>
      </div>
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6">
        ...
        >
          ...
          <div class="leading-tight">
            <p class="text-xs font-semibold text-[var(--color-text-primary)] dark:text-white">
              {{ item.title }}
            </p>
