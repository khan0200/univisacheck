...
import { displayStatusText, statusBadgeColor, isSupplementStatus, isSupplementSubmittedStatus } from '~/utils/visa-status'
...
const icon = computed(() => {
  ...
  if (isSupplementSubmittedStatus(s)) return 'i-lucide-file-check'
