...
<template>
  <div class="grid grid-cols-4 sm:inline-flex sm:items-center gap-1 p-1 rounded-md bg-primary-900 w-full sm:w-auto max-w-full">
    <button
      v-for="tab in tabs"
      :key="tab.value"
      type="button"
      class="relative flex flex-col sm:flex-row items-center justify-center gap-0.5 sm:gap-1.5 rounded-sm px-1.5 sm:px-3 py-1.5 text-[11px] sm:text-sm font-medium leading-tight transition-colors duration-150"
