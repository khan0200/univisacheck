  ...
  <div class="min-h-screen flex items-center justify-center px-4">
    <div class="w-full max-w-sm">
      <div class="flex flex-col items-center mb-6">
        ...
        <h1 class="text-lg font-semibold text-[var(--color-text-primary)] dark:text-white">Leads Dashboard</h1>
        <p class="text-sm text-[var(--color-text-secondary)] mt-1">Admin parolini kiriting</p>
      </div>

      <UCard :ui="{ body: 'p-6' }">
        <form class="space-y-4" @submit.prevent="attemptLogin">
          <UInput
            v-model="password"
            type="password"
          ...
          <UiLoadingButton type="submit" block size="lg" color="primary" :loading="loading">
            Kirish
          </UiLoadingButton>
        </form>
      </UCard>
