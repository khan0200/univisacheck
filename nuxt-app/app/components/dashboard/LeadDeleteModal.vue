...
<template>
  <UModal :open="props.open" title="Lidni o'chirish" @update:open="emit('update:open', $event)">
    <template #body>
    ...
    <template #footer>
      <div class="flex justify-end gap-2 w-full">
        ...
        <UiLoadingButton color="error" :loading="deleting" @click="handleDelete">O'chirish</UiLoadingButton>
      </div>
    </template>
  </UModal>
</template>
