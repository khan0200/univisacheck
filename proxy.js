            ...
            try {
                ...
                if (!geminiKey) {
                    ...
                    res.end(JSON.stringify({
                        response: "⚠️ **Gemini API Key Missing**: Please set `GEMINI_API_KEY` in `turso.config.js` or as an environment variable to enable the AI Admission Assistant."
                    }));
                    return;
                }
...
#### 📍 Boshqa Hududlardagi Universitetlar (Busan, Daegu, Incheon tashqari, Cheonan va h.k. — O'rtacha Talablar):
...
- $12,000 - $14,000 USD tavsiya etiladigan minimum — bu 1% yengillashtirilgan universitet uchun ham, standart uchun ham amal qiladi
- Standart (non-1%) universitetlar uchun elchixona ba'zan $16,000 USD 31 kunlik KDB hisobidan ham so'rashi mumkin — bu talabdan farq qiladi
